    ...
    <div className="grid place-items-center h-[80vh]">
      <div className="shadow-lg p-5 rounded-lg border-t-4 border-green-400 bg-white">
        ...
        <form onSubmit={handleSubmit} id="login-form" className="flex flex-col gap-3">
          <input onChange={handleChange} value={user.firstName} name="firstName" type="text" placeholder="First Name" />
          <input onChange={handleChange} value={user.lastName} name="lastName" type="text" placeholder="Last Name" />
          <input onChange={handleChange} value={user.email} name="email" type="text" placeholder="Email" />
